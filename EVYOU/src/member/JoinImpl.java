		...
		try
		{
			...
			if(!pwd.isEmpty())
			{
				...
				if (result == 1)
				{
					try
					{
						Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/CompleteAlert.fxml"));
			...
			{
				Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/CheckAlert.fxml"));
				Scene scene = new Scene(root);
		        Stage stage = new Stage();
		        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
		        stage.setScene(scene);
