		...
		{	
			try
			{
				...
				if(mtemp.getId() != null)
				{
					...
					{
						try {
							Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/LoginAlert.fxml"));
				...
				if(mtemp.getId() != null)
				{
					...
					if(selectedIndex>=0)
					{
						...
						if(searchResult == false)
						{
							...
							try
							{
								Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/FavorAddAlert.fxml"));
								Scene scene = new Scene(root);
						        Stage stage = new Stage();
						        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
						        stage.setScene(scene);
						...
						else
						{
							...
							try
							{
								Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/FavorDelAlert.fxml"));
								Scene scene = new Scene(root);
						        Stage stage = new Stage();
						        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
						        stage.setScene(scene);
					...
					else
					{
						/** 선택한 자료가 없을 경우 안내처리 */
						try {
							Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/FavorDataAlert.fxml"));
							Scene scene = new Scene(root);
					        Stage stage = new Stage();
					        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
					        stage.setScene(scene);
			...
			try
			{
				if(mtemp.getId() != null)
				{
					if(mtemp.getStat_name() != null)
					{
						...
						try
						{
							Parent parent = FXMLLoader.load(getClass().getResource("/main/fxml/paypopup.fxml"));
					...
					else
					{
						try
						{
							Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/EVAlert.fxml"));
							Scene scene = new Scene(root);
					        Stage stage = new Stage();
					        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
					        stage.setScene(scene);
