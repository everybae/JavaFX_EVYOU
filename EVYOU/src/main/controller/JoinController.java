	...
	public void initialize(URL location, ResourceBundle resources)
	{
	    ...
	    checkId.setOnAction((e)->
	    {
	    	...
	    	if((join.check(id)) == true)
	    	{
	    		try
	    		{
			    	Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/NotuseAlert.fxml"));
	    	...
	    	else
	    	{
	    		try
	    		{
			    	Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/UsableAlert.fxml"));
					Scene scene = new Scene(root);
				    Stage stage = new Stage();
				    stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
				    stage.setScene(scene);
