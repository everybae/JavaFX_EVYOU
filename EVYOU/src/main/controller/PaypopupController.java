		...
		payon.setOnAction((event)->
		{
			try
			{
				...
				if(usage < 0)
				{
					try
					{
						Parent root = FXMLLoader.load(getClass().getResource("PNumAlert.fxml"));
				...
				else
				{
					...
					try
					{
						Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/PayAlert.fxml"));
						Scene scene = new Scene(root);
				        Stage stage = new Stage();
				        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
				        stage.setScene(scene);
			...
			{
				try {
					Parent root = FXMLLoader.load(getClass().getResource("IntegersAlert.fxml"));
					Scene scene = new Scene(root);
			        Stage stage = new Stage();
			        stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
			        stage.setScene(scene);
