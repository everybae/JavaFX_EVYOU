...
public class LoginSideBarController implements Initializable 
{
    ...
    public void initialize(URL url, ResourceBundle rb)
    {
		...
		login_bt.setOnAction((evnet)->
	    {
		    ...
		    if((log.tryLogin(id, pwd)) == 1)
		    {
				...
				try {
					Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/SuccessAlert.fxml"));
		    	...
		    	id = null;
		    	try {
		    	Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/FailAlert.fxml"));
				Scene scene = new Scene(root);
			    Stage stage = new Stage();
			    stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
			    stage.setScene(scene);
		...
		joinBtn.setOnAction((event) ->
		{
			Parent root;
			try {
				root = FXMLLoader.load(getClass().getResource("/main/fxml/join.fxml"));
				Scene scene = new Scene(root);
			    Stage stage = new Stage();
			    stage.getIcons().add(new Image("file:src\\main\\images\\Lightning.png" ));
			    stage.setScene(scene);
    ...
    private void loadPage(String page) {
        try {
            Parent root = FXMLLoader.load(getClass().getResource("/main/fxml/" +page + ".fxml"));
            bp.setCenter(root);
